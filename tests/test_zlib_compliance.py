...
class ChecksumTestCase(unittest.TestCase):
    ...
    def test_crc32_combine(self):
        foo = b'abcdefghijklmnop'
        self.assertEqual(zlib.crc32_combine(0, 0, 0), 0)
        self.assertEqual(zlib.crc32_combine(1, 0, 0), 1)
        self.assertEqual(zlib.crc32_combine(432, 0, 0), 432)
        self.assertEqual(
            zlib.crc32_combine(
                zlib.crc32(foo), zlib.crc32(foo), len(foo)),
            zlib.crc32(foo + foo)
        )
...
class ExceptionTestCase(unittest.TestCase):
    ...
    def test_badcompressobj(self):
        ...
        self.assertRaises(ValueError,
                          zlib.compressobj, 1, zlib.DEFLATED,
                          zlib.MAX_WBITS + 1)
    ...
    def test_pair(self):
        ...
        for data in (datasrc, bytearray(datasrc)):
            ...
            self.assertRaises(zlib.error,
                              co.flush)  # second flush should not work
...
class ZlibDecompressorTest(unittest.TestCase):
    ...
    def test_Constructor(self):
        ...
        self.assertRaises(TypeError, zlib._ZlibDecompressor, -15, b"bla",
                          "bla")
